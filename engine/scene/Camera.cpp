...
void Camera::set_view(float eye_x, float eye_y, float eye_z,
...
void Camera::set_projection(float fov_degrees, float aspect_ratio,
...
void Camera::pan(float delta_x, float delta_y, float delta_z) {
...
void Camera::compute_projection_matrix(float aspect_ratio) {
...
void Camera::compute_view_projection_matrix() {
