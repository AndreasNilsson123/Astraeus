...
void GridPass::execute(RenderDevice* device, World* world) {
    (void)device;
...
void GridPass::on_resize(uint32_t width, uint32_t height) {
    viewport_width_ = width;
    viewport_height_ = height;
}

void GridPass::create_geometry() {
...
void GridPass::destroy_geometry() {
    if (vao_ != 0) {
