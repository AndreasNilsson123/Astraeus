 ...
 * </pre>
 */
public class FxViewportV2 extends StackPane {
     ...
     */
    public FxViewportV2(NativeEngine engine, int maxWidth, int maxHeight,
        ...
        System.out.println("[FxViewportV2] Created viewport with controller and overlays");
    }
    ...
    private void handleMouseClick(MouseEvent event) {
        try {
            ...
            System.err.println("[FxViewportV2] Picking error: " + e.getMessage());
        }
    }
